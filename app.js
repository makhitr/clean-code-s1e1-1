...
var taskInput=document.getElementById("section__task_new");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.getElementById("list__tasks_incompleted");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("list__tasks_completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
  ...
  label.classList.add("section__task__label", "section__task")
  ...
  editInput.type="text";
  editInput.classList.add("section__task", "task__input")
  ...
  deleteButtonImg.classList.add("image_delete")
